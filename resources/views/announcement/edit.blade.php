                                    ...
                                    <div class="col-xs-12">
                                        <form method="post" action="/announcements/{{ $announcement->id }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                @enderror" id="title" placeholder="Masukan title" name="title" value="{{$announcement->title}}">
                                                @error ('title')
                                            ...
                                            <div class="form-group">
                                                ...
                                                @enderror" id="description" placeholder="Masukan description" name="description" value="{{ $announcement->description }}">
                                                @error ('description')
                                                <div class="invalid-feedback">{{$message}}</div>
                                                @enderror
                                            </div>
