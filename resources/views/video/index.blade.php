          ...
          <div class="box-body">
            <div class="row">
              <div class="col-md-12">
                <div class="row">
                  <div class="col-xs-12">
                    <a href="/videos/create" class="btn btn-success btn-xs">
                    ...
                    <div class="box-body table-responsive no-padding">
                      <table class="table table-hover table-bordered">
                        ...
                        <td>{{$v->url}}</td>
                          <td>
                            <a href="videos/{{ $v->id }}" class="btn btn-xs btn-primary">
                              <i class="glyphicon glyphicon-eye-open"></i>
                            </a>
                            <a  href="/videos/{{ $v->id}}/edit" class="btn btn-xs btn-warning">
                              <i class="glyphicon glyphicon-edit"></i>
                            </a>
                            <form action="/videos/{{ $v->id }}" method="post" style="display: inline-block;">
                             @method('delete')
                             @csrf
