...
Route::get('pengumuman', [App\Http\Controllers\PageController::class, 'announcement']);
Route::get('sejarah-sekolah', [App\Http\Controllers\PageController::class, 'history']);
Route::get('visi-misi', [App\Http\Controllers\PageController::class, 'visionMission']);
Route::get('galery-foto', [App\Http\Controllers\PageController::class, 'galeryPhoto']);
Route::get('galery-video', [App\Http\Controllers\PageController::class, 'galeryVideo']);
Route::get('berita-sekolah', [App\Http\Controllers\PageController::class, 'news']);
Route::get('berita-terbaru/{berita}', [App\Http\Controllers\PageController::class, 'newsDetail']);
